...
class Products(Base):
    ...
    route_product1 = Column(String(255))
    route_product2 = Column(String(255))
    route_product3 = Column(String(255))
    route_product4 = Column(String(255))
    route_product5 = Column(String(255))
    route_product6 = Column(String(255))
    route_product7 = Column(String(255))
    route_product8 = Column(String(255))
    route_product9 = Column(String(255))
    route_product10 = Column(String(255))
